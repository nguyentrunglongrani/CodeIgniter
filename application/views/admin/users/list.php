...
height: 26px;"');
              ...
              echo form_label('Filter by courser:', 'course_id');
              echo form_dropdown('course_id', $options_course, $course_selected, 'class="span2"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="red header">Time Learn</th>
                <th class="red header">Time Use</th>
                <th class="red header">Course</th>
            ...
            <tbody>
              ...
              foreach($users as $row)
              {
                ...
                echo '<td>'.$row['timelearn'].'</td>';
                echo '<td>'.$row['timeuse'].'</td>';
